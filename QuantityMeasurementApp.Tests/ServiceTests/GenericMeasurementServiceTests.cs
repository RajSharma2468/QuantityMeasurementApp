...
public class GenericMeasurementServiceTests
{
    ...
    [Fact]
    public void AddMeasurementsWithTarget_Length_Works()
    {
        var a = new GenericQuantity<LengthUnit>(1, LengthUnit.Feet);
        var b = new GenericQuantity<LengthUnit>(12, LengthUnit.Inch);
        var r = _service.AddMeasurementsWithTarget(a, b, LengthUnit.Inch);
    ...
    [Fact]
    public void SubtractMeasurementsWithTarget_Length_Works()
    {
        var a = new GenericQuantity<LengthUnit>(10, LengthUnit.Feet);
        var b = new GenericQuantity<LengthUnit>(6, LengthUnit.Inch);
        var r = _service.SubtractMeasurementsWithTarget(a, b, LengthUnit.Inch);
        
        Assert.Equal(114, r.Value);
    }
    ...
    [Fact]
    public void DivideMeasurements_ByZero_Throws()
    {
        var a = new GenericQuantity<LengthUnit>(10, LengthUnit.Feet);
        var b = new GenericQuantity<LengthUnit>(0, LengthUnit.Feet);
        
        Assert.Throws<DivisionByZeroException>(() => _service.DivideMeasurements(a, b));
    }
