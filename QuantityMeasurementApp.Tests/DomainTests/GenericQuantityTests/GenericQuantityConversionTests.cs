...
public class GenericQuantityConversionTests
{
    ...
    public void Length_FeetToYard_ShouldConvertCorrectly()
    {
        ...
        Assert.Equal(LengthUnit.Yard.GetUnitSymbol(), converted.Unit.GetUnitSymbol());
    }
    ...
    public void Convert_SameUnit_ShouldReturnSameValue()
    {
        ...
        Assert.Equal(original.Unit.GetUnitSymbol(), converted.Unit.GetUnitSymbol());
    }
    ...
    {
        // Arrange
        var weight = new GenericQuantity<WeightUnit>(0, WeightUnit.Kilogram);
        
        // Act
        var converted = weight.ConvertTo(WeightUnit.Gram);
        
        // Assert
        Assert.Equal(0, converted.Value, Epsilon);
    }
    ...
    public void Convert_NegativeValue_ShouldPreserveSign()
    {
        ...
        // Assert
        Assert.Equal(-5000, converted.Value, Epsilon);
    }
