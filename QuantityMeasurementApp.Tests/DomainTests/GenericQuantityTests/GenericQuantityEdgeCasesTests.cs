...
public class GenericQuantityEdgeCasesTests
{
    ...
    [Fact]
    public void VeryLargeValues_ShouldMaintainPrecision()
    {
        // Arrange
        var veryLarge = 1e10;
        var q1 = new GenericQuantity<WeightUnit>(veryLarge, WeightUnit.Kilogram);
        var q2 = q1.ConvertTo(WeightUnit.Gram);
        var q3 = q2.ConvertTo(WeightUnit.Kilogram);
        
        // Act & Assert
        Assert.True(Math.Abs(q1.Value - q3.Value) < 1e-5);
    }
